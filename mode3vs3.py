...
def team2_pick():
    ...
    character_list.remove(f'[{pick1}]')
    if pick1 == '기사':
        player4 = character.Knight(f'{team2_name[0]}')
    elif pick1 == '무사':
        player4 = character.Samurai(f'{team2_name[0]}')
    elif pick1 == '격투가':
    ...
    character_list.remove(f'[{pick1}]')
    if pick1 == '기사':
        player5 = character.Knight(f'{team2_name[1]}')
    elif pick1 == '무사':
        player5 = character.Samurai(f'{team2_name[1]}')
    elif pick1 == '격투가':
        player5 = character.Fighter(f'{team2_name[1]}')
    print()
    ...
    character_list.remove(f'[{pick1}]')
    if pick1 == '기사':
        player6 = character.Knight(f'{team2_name[2]}')
    elif pick1 == '무사':
        player6 = character.Samurai(f'{team2_name[2]}')
    elif pick1 == '격투가':
        player6 = character.Fighter(f'{team2_name[2]}')
    print()
