...
def team1_pick():
    ...
    if pick1 == '기사':
        player1 = character.Knight(f'{team2_name[0]}')
    elif pick1 == '무사':
        player1 = character.Samurai(f'{team2_name[0]}')
    elif pick1 == '격투가':
    ...
    character_list.remove(f'[{pick1}]')
    if pick1 == '기사':
        player2 = character.Knight(f'{team2_name[1]}')
    elif pick1 == '무사':
        player2 = character.Samurai(f'{team2_name[1]}')
    elif pick1 == '격투가':
        player2 = character.Fighter(f'{team2_name[1]}')
    print()
...
def team2_pick():
    ...
    character_list.remove(f'[{pick1}]')
    if pick1 == '기사':
        player3 = character.Knight(f'{team2_name[0]}')
    elif pick1 == '무사':
        player3 = character.Samurai(f'{team2_name[0]}')
    elif pick1 == '격투가':
    ...
    character_list.remove(f'[{pick1}]')
    if pick1 == '기사':
        player4 = character.Knight(f'{team2_name[1]}')
    elif pick1 == '무사':
        player4 = character.Samurai(f'{team2_name[1]}')
    elif pick1 == '격투가':
