...
class Button:
    ...
    def __init__(self, screen, x, y, w, h, box_color, text, text_size, text_color, text_color_yes):
        if Button.fonts is None:
            Button.fonts = {
                "s": pygame.font.SysFont("malgungothic", 30, True),
                "sn": pygame.font.SysFont("malgungothic", 40, True),
                "n": pygame.font.SysFont("malgungothic", 50, True),
                "nb": pygame.font.SysFont("malgungothic", 75, True),
                "b": pygame.font.SysFont("malgungothic", 100, True),
}
        self.screen = screen
        self.box_x = x
        self.box_y = y
