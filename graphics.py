...
print(width, height)
width = storyMAIN2.get_width()
height = storyMAIN2.get_height()
print(width, height)
width = storySIDE1.get_width()
height = storySIDE1.get_height()
print(width, height)
width = storySIDE2.get_width()
height = storySIDE2.get_height()
print(width, height)
