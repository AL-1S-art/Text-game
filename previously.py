...
backtitle = pygame.image.load(os.path.join(base_path, "Graphics/scene_intro/backtitle.png"))
...
mainback = pygame.image.load(os.path.join(base_path, "Graphics/scene_main/mainback.png"))
mainback = pygame.transform.scale(mainback, (1920, 1080))
bookback = pygame.image.load(os.path.join(base_path, "Graphics/scene_character_dict/bookback.png"))
...
home_settingback = pygame.image.load(os.path.join(base_path, "Graphics/scene_home_setting/home_settingback.png"))
home_settingback = pygame.transform.scale(home_settingback, (1920, 1080))
modeback = pygame.image.load(os.path.join(base_path, "Graphics/scene_character_dict/characterback.png"))
modeback = pygame.transform.scale(modeback, (1920, 1080))
endback = pygame.image.load(os.path.join(base_path, "Graphics/scene_confirm_quit/endback.png"))
endback = pygame.transform.scale(endback, (1920, 1080))
Naturalist = pygame.image.load(os.path.join(base_path, "Graphics/character_design/design_Naturalist.png"))
...
while running:
    ...
    if scene == "main":
        ...
        if is_enter_down == True:
            if x_main_pick == 235:
                next_scene = "game_mode_pick"
                fade_mode = "out"
            elif x_main_pick == 760:
                next_scene = "story_mode_pick"
                fade_mode = "out"
            elif x_main_pick == 1285:
                next_scene = "character_pick"
                fade_mode = "out"
            is_enter_down = False
        ...
        if is_mouse_down == True:
            if mouse_y >= 900 and mouse_y <= 1034:
                if 797 <= mouse_x and mouse_x <= 1123:
                    next_scene = "confirm_program_quit"
                    fade_mode = "out"
            is_mouse_down = False
...
#배경
    ...
    if scene == "story_mode_pick":
        ...
        pygame.draw.rect(screen, (0, 0, 0), (360, 90, 500, 900))
        pygame.draw.rect(screen, (0, 0, 0), (1060, 90, 500, 900))
        pygame.draw.rect(screen, (255, 0, 0), (x_story_mode_pick, 212.5, 400, 805))
